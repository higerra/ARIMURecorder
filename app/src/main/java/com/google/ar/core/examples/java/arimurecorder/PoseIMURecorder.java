...
public class PoseIMURecorder {
    ...
    private final static String LOG_TAG = PoseIMURecorder.class.getSimpleName();

    HelloArActivity parent_;
    ...
    public static final int AR_POSE = 6;
    ...
    public PoseIMURecorder(String path, HelloArActivity parent){
        parent_ = parent;
        output_dir = path;
